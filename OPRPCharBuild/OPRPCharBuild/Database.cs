...
namespace OPRPCharBuild
{
    public static class Database
    {
        ...
        static private Dictionary<string, Rokushiki> rokuDict = new Dictionary<string, Rokushiki>() {
            ...
            { ROKU_SHI, new Rokushiki(ROKU_SHI, 20, "Offensive", "Melee", 8, 0, 0, 0, 0,
            ...
            { ROKU_GEP, new Rokushiki(ROKU_GEP, 32, "Support", "Self", 0, 0, 0, 0, 0,
        ...
        public const string EFF_DISPL = "Displacement",
            ...
            EFF_WDEFC = "Wooden Defenses (Carp)",
            ...
            EFF_WDEFP = "Wooden Defenses (Pop)",
            EFF_ELEPG = "Elemental Damage (Pop)",
            EFF_SMOKE = "Smoke",
        ...
        static private Dictionary<string, Effect> effectDict = new Dictionary<string, Effect>() {
            ...
            { EFF_DURAT, new Effect(EFF_DURAT, false, 8, 8,
                "Encompasses all damage over time abilities. Deep cuts that cause bleeding or venom that cause persistent pain. Higher Power techniques can include other effects that persist for several turns.") },
            ...
            { EFF_LASNW, new Effect(EFF_LASNW, false, 0, 44,
                "Techniques which are beams fired at the speed of light. They shoot in straight lines and tend to only be narrowly avoided. New World Cyborg lasers get this effect for free. This effect is restricted to Lasers from Cyborgs & Inventors.") },
            ...
            { EFF_TRAPS, new Effect(EFF_TRAPS, false, 4, 4,
                "(CARPENTER) - Traps come in all kinds of shapes and sizes, ranging from a simple mouse trap to even more elaborate contraptions such as swinging log traps, or booby-trapped household property. These creations are made to hinder and restrict, but are considered tierless in terms of their defenses. Higher ranks can have more complex set-ups, remote triggers or include more dangerous elements and be generally more difficult to detect. Traps are more effective with higher Power. Note that there is a cap with Traps, refer to Rules for more details.") },
            { EFF_STRUC, new Effect(EFF_STRUC, true, 4, 4,
                "(CARPENTER) -Carpenters can craft different kinds of furniture for supportive purposes, such as chairs and tables. They can also make ladders, form temporary rafts, trampolines and other useful items that would normally need to be purchased. These creations have a base duration that follows the Duration table. Additionally, weapons created in the image of a weapon that a player has techniques for may be used in place of the actual weapon. Structure Techniques cannot have Material Defense tiers (unless DF). They are limited to General Effects, Extra General and Range/AoE. More effective in their purpose with higher Power. Full Body effect to be used when structure is covering user's body.") },
            { EFF_WDEFC, new Effect(EFF_WDEFC, false, 4, 4,
            ...
            { EFF_BSUIT, new Effect(EFF_BSUIT, false, 4, 28,
